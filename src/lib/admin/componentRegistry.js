...
export const componentRegistry = {
    ...
    'news': {
        ...
        configurable: {
            limit: { type: 'number', label: 'Number of Articles', default: 5, min: 3, max: 15 },
            showImages: { type: 'boolean', label: 'Show Article Images', default: true }
        },
        defaultProps: {
            limit: 5,
            showImages: true
    ...
    'blog-post': {
        ...
        configurable: {
            showExcerpt: { type: 'boolean', label: 'Show Post Excerpt', default: true },
            maxExcerptLength: { type: 'number', label: 'Excerpt Length', default: 200, min: 100, max: 500 }
        },
        defaultProps: {
            showExcerpt: true,
    ...
    'blog-posts': {
        ...
        configurable: {
            postsPerPage: { type: 'number', label: 'Posts Per Page', default: 10, min: 5, max: 25 },
    ...
    'resources': {
        ...
        configurable: {
            ...
            openInNewTab: { type: 'boolean', label: 'Open Links in New Tab', default: true }
        },
        defaultProps: {
            showCategories: true,
            openInNewTab: true
    ...
    'standings': {
        ...
        configurable: {
            ...
            showPoints: { type: 'boolean', label: 'Show Points For/Against', default: true },
            compactView: { type: 'boolean', label: 'Compact View', default: false },
            highlightPlayoffs: { type: 'boolean', label: 'Highlight Playoff Teams', default: true }
        },
        defaultProps: {
            showWeek: true,
            showPoints: true,
    ...
    'power-rankings': {
        ...
        configurable: {
            ...
            chartHeight: { type: 'number', label: 'Chart Height (px)', default: 400, min: 300, max: 600 }
        },
        defaultProps: {
            animated: true,
            showTrend: true,
    ...
    'transactions': {
        ...
        configurable: {
            limit: { type: 'number', label: 'Number of Transactions', default: 10, min: 5, max: 50 },
            showTypes: { 
                type: 'multi-select', 
            ...
            showDate: { type: 'boolean', label: 'Show Transaction Date', default: true }
        },
        defaultProps: {
            limit: 10,
    ...
    'transactions-page': {
        ...
        configurable: {
            showFilters: { type: 'boolean', label: 'Show Filter Options', default: true },
            showSearch: { type: 'boolean', label: 'Show Search Bar', default: true },
            transactionsPerPage: { type: 'number', label: 'Transactions Per Page', default: 25, min: 10, max: 100 }
        },
        defaultProps: {
            showFilters: true,
            showSearch: true,
    ...
    'rosters': {
        ...
        configurable: {
            showPositions: { type: 'boolean', label: 'Show Player Positions', default: true },
    ...
    'matchups-brackets': {
        ...
        configurable: {
            showScores: { type: 'boolean', label: 'Show Final Scores', default: true },
            showProjections: { type: 'boolean', label: 'Show Projections', default: false },
            highlightCurrent: { type: 'boolean', label: 'Highlight Current Week', default: true }
        },
        defaultProps: {
            showScores: true,
    ...
    'drafts': {
        ...
        configurable: {
            showGrades: { type: 'boolean', label: 'Show Draft Grades', default: true },
            showTrades: { type: 'boolean', label: 'Show Traded Picks', default: true },
            draftYear: { type: 'select', label: 'Draft Year', options: ['current', 'all'], default: 'current' }
        },
        defaultProps: {
            showGrades: true,
            showTrades: true,
    ...
    'all-managers': {
        ...
        configurable: {
            ...
            showStats: { type: 'boolean', label: 'Show Manager Stats', default: true },
            photosPerRow: { type: 'number', label: 'Photos Per Row', default: 3, min: 2, max: 6 }
        },
        defaultProps: {
            layout: 'grid',
            showBio: true,
    ...
    'single-manager': {
        ...
        configurable: {
            showAdvancedStats: { type: 'boolean', label: 'Show Advanced Stats', default: true },
            showHistory: { type: 'boolean', label: 'Show Season History', default: true },
    ...
    'rivalry': {
        ...
        configurable: {
            showStats: { type: 'boolean', label: 'Show Rivalry Stats', default: true },
            animated: { type: 'boolean', label: 'Animated Charts', default: true },
            showAllRivalries: { type: 'boolean', label: 'Show All Rivalries', default: false }
        },
        defaultProps: {
            showStats: true,
            animated: true,
    ...
    'awards': {
        ...
        configurable: {
            showYears: { type: 'number', label: 'Years to Display', default: 5, min: 1, max: 20 },
            showDetails: { type: 'boolean', label: 'Show Award Details', default: true },
    ...
    'records': {
        ...
        configurable: {
            ...
            showDetails: { type: 'boolean', label: 'Show Record Details', default: true },
            showTop: { type: 'number', label: 'Show Top N Records', default: 10, min: 5, max: 25 }
        },
        defaultProps: {
            recordType: 'all-time',
            showDetails: true,
    ...
    'bar-chart': {
        ...
        configurable: {
            ...
            height: { type: 'number', label: 'Chart Height (px)', default: 300, min: 200, max: 600 },
    ...
    'enhanced-bar-chart': {
        ...
        configurable: {
            ...
            height: { type: 'number', label: 'Chart Height (px)', default: 400, min: 250, max: 700 },
    ...
    'radar-chart': {
        ...
        configurable: {
            ...
            size: { type: 'number', label: 'Chart Size (px)', default: 300, min: 200, max: 500 },
            showLabels: { type: 'boolean', label: 'Show Axis Labels', default: true },
            fillOpacity: { type: 'number', label: 'Fill Opacity', default: 0.3, min: 0, max: 1, step: 0.1 }
        },
        defaultProps: {
    ...
    'trend-chart': {
        ...
        configurable: {
            ...
            height: { type: 'number', label: 'Chart Height (px)', default: 350, min: 200, max: 600 },
    ...
    'pagination': {
        ...
        configurable: {
            itemsPerPage: { type: 'number', label: 'Items Per Page', default: 10, min: 5, max: 50 },
            showFirstLast: { type: 'boolean', label: 'Show First/Last Buttons', default: true },
    ...
    'footer': {
        ...
        configurable: {
            showCredits: { type: 'boolean', label: 'Show League Page Credits', default: true },
...
export function getComponentsByCategory() {
    ...
    const categoryOrder = ['Content', 'League Data', 'Managers', 'Historical', 'Charts', 'Layout', 'System'];
...
export function validateComponentProps(componentKey, props) {
    ...
    if (!config) return { valid: false, errors: [`Unknown component: ${componentKey}`] };
            ...
            switch (propConfig.type) {
                case 'number':
                    if (typeof value !== 'number' || isNaN(value)) {
                        ...
                        if (propConfig.min !== undefined && value < propConfig.min) {
                            errors.push(`Prop '${propKey}' must be at least ${propConfig.min}`);
                        }
                        if (propConfig.max !== undefined && value > propConfig.max) {
                            errors.push(`Prop '${propKey}' must be at most ${propConfig.max}`);
                        }
                    }
                    break;
                case 'boolean':
                ...
                case 'select':
                    if (!propConfig.options.includes(value)) {
                        errors.push(`Prop '${propKey}' must be one of: ${propConfig.options.join(', ')}`);
                    }
                    break;
                case 'multi-select':
                    if (!Array.isArray(value)) {
                        ...
                        const invalidOptions = value.filter(v => !propConfig.options.includes(v));
                        if (invalidOptions.length > 0) {
                            errors.push(`Invalid options for '${propKey}': ${invalidOptions.join(', ')}`);
                        }
                    }
                    break;
                case 'text':
                case 'rich-text':
                    ...
                    } else if (propConfig.maxLength && value.length > propConfig.maxLength) {
                        warnings.push(`Prop '${propKey}' is longer than recommended (${propConfig.maxLength} chars)`);
                    }
                    break;
            }
        }
    ...
    Object.values(componentRegistry).forEach(config => {
        ...
        if (config.requiresData) {
            config.requiresData.forEach(dataType => {
                stats.dataRequirements[dataType] = (stats.dataRequirements[dataType] || 0) + 1;
            });
        }
