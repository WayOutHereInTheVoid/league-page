...
async function testCorrectLeagueID() {
    try {
        ...
        const usersResponse = await fetch(`https://api.sleeper.app/v1/league/${correctLeagueID}/users`);
        ...
        const rostersResponse = await fetch(`https://api.sleeper.app/v1/league/${correctLeagueID}/rosters`);
